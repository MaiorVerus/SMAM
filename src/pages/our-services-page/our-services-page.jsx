                ...
                <main>
                    ...
                    <div className="services-grid">
                        <article className="service-card">
                            <h2><span className="icon-box"> <i className="fa-solid fa-scale-balanced"></i>
                        ...
                        <article className="service-card">
                            <h2><span className="icon-box"><i className="fa-solid fa-shield-halved"></i></span> Expense Shield</h2>
                        ...
                        <article className="service-card">
                            <h2><span className="icon-box"><i className="fa-solid fa-handshake"></i></span> Mentorship</h2>
